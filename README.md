...
<h2>Improvements</h2>
  ...
  - The `set_tuner_gain` algorithm follows the datasheet recommendation and reduces the gain of the front stages with priority to improve the large signal capability of the tuner.
...
The distribution of the gain onto the internal stages *LNA* (or the upmixer), *baseband*, and *IQ mixer* follows the recommendations given in the datasheet.
